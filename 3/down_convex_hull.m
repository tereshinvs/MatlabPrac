function result = down_convex_hull(pnts)
% This function returs lower convex hull for pnts for QuickHull algo.
	EPS = 10e-9;
	N = size(pnts, 2);
	if N <= 2
		result = pnts(3, :)';
	...
	left_res = down_convex_hull(left_points);
	right_res = down_convex_hull(right_points);
